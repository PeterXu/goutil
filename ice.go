...
// maybe divided into several packets
func IsDtlsComplete(data []byte) bool {
	for tmpData := data; len(tmpData) > 0; {
		if len(tmpData) < kDtlsRecordHeaderLen {
			return false
		}
